# [ROOT](https://github.com/LafeLabs/spore/blob/main/tarot/19/)
...
showdown.js IS A JAVASCRIPT LIBRARY TO CONVERT [MARKDOWN](https://en.wikipedia.org/wiki/Markdown) INTO HTML!